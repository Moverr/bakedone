...
-- Dumping database structure for mifostenant-default
...
DELETE FROM `c_account_number_format`;
...
DELETE FROM `c_external_service_properties`;
...
INSERT INTO `job` (`id`, `name`, `display_name`, `cron_expression`, `create_time`, `task_priority`, `group_name`, `previous_run_start_time`, `next_run_time`, `job_key`, `initializing_errorlog`, `is_active`, `currently_running`, `updates_allowed`, `scheduler_group`, `is_misfired`) VALUES
	(1, 'Update loan Summary', 'Update loan Summary', '0 0 22 1/1 * ? *', '2017-01-23 22:35:24', 5, NULL, NULL, '2017-01-24 19:30:00', 'Update loan SummaryJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(2, 'Update Loan Arrears Ageing', 'Update Loan Arrears Ageing', '0 1 0 1/1 * ? *', '2017-01-23 22:35:24', 5, NULL, NULL, '2017-01-24 21:31:00', 'Update Loan Arrears AgeingJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(3, 'Update Loan Paid In Advance', 'Update Loan Paid In Advance', '0 5 0 1/1 * ? *', '2017-01-23 22:35:24', 5, NULL, NULL, '2017-01-24 21:35:00', 'Update Loan Paid In AdvanceJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(4, 'Apply Annual Fee For Savings', 'Apply Annual Fee For Savings', '0 20 22 1/1 * ? *', '2017-01-23 22:35:24', 5, NULL, NULL, '2017-01-24 19:50:00', 'Apply Annual Fee For SavingsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(5, 'Apply Holidays To Loans', 'Apply Holidays To Loans', '0 0 12 * * ?', '2017-01-23 22:35:24', 5, NULL, NULL, '2017-01-24 09:30:00', 'Apply Holidays To LoansJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(6, 'Post Interest For Savings', 'Post Interest For Savings', '0 0 0 1/1 * ? *', '2017-01-23 22:35:30', 5, NULL, NULL, '2017-01-24 21:30:00', 'Post Interest For SavingsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 1, 0),
	(7, 'Transfer Fee For Loans From Savings', 'Transfer Fee For Loans From Savings', '0 1 0 1/1 * ? *', '2017-01-23 22:35:41', 5, NULL, NULL, '2017-01-24 21:31:00', 'Transfer Fee For Loans From SavingsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(8, 'Pay Due Savings Charges', 'Pay Due Savings Charges', '0 0 12 * * ?', '2013-09-23 00:00:00', 5, NULL, NULL, '2017-01-24 09:30:00', 'Pay Due Savings ChargesJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(9, 'Update Accounting Running Balances', 'Update Accounting Running Balances', '0 1 0 1/1 * ? *', '2017-01-23 22:35:45', 5, NULL, NULL, '2017-01-24 21:31:00', 'Update Accounting Running BalancesJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(10, 'Execute Standing Instruction', 'Execute Standing Instruction', '0 0 0 1/1 * ? *', '2017-01-23 22:36:03', 5, NULL, NULL, '2017-01-24 21:30:00', 'Execute Standing InstructionJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(11, 'Add Accrual Transactions', 'Add Accrual Transactions', '0 1 0 1/1 * ? *', '2017-01-23 22:36:04', 3, NULL, NULL, '2017-01-24 21:31:00', 'Add Accrual TransactionsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 3, 0),
	(12, 'Apply penalty to overdue loans', 'Apply penalty to overdue loans', '0 0 0 1/1 * ? *', '2017-01-23 22:36:04', 5, NULL, NULL, '2017-01-24 21:30:00', 'Apply penalty to overdue loansJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(13, 'Update Non Performing Assets', 'Update Non Performing Assets', '0 0 0 1/1 * ? *', '2017-01-23 22:36:05', 6, NULL, NULL, '2017-01-24 21:30:00', 'Update Non Performing AssetsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 3, 0),
	(14, 'Transfer Interest To Savings', 'Transfer Interest To Savings', '0 2 0 1/1 * ? *', '2017-01-23 22:36:09', 4, NULL, NULL, '2017-01-24 21:32:00', 'Transfer Interest To SavingsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 1, 0),
	(15, 'Update Deposit Accounts Maturity details', 'Update Deposit Accounts Maturity details', '0 0 0 1/1 * ? *', '2017-01-23 22:36:10', 5, NULL, NULL, '2017-01-24 21:30:00', 'Update Deposit Accounts Maturity detailsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(16, 'Add Periodic Accrual Transactions', 'Add Periodic Accrual Transactions', '0 2 0 1/1 * ? *', '2017-01-23 22:36:18', 2, NULL, NULL, '2017-01-24 21:32:00', 'Add Periodic Accrual TransactionsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 3, 0),
	(17, 'Recalculate Interest For Loans', 'Recalculate Interest For Loans', '0 1 0 1/1 * ? *', '2017-01-23 22:36:20', 4, NULL, NULL, '2017-01-24 21:31:00', 'Recalculate Interest For LoansJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 3, 0),
	(18, 'Generate Mandatory Savings Schedule', 'Generate Mandatory Savings Schedule', '0 5 0 1/1 * ? *', '2017-01-23 22:36:46', 5, NULL, NULL, '2017-01-24 21:35:00', 'Generate Mandatory Savings ScheduleJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(19, 'Generate Loan Loss Provisioning', 'Generate Loan Loss Provisioning', '0 0 0 1/1 * ? *', '2017-01-23 22:36:59', 5, NULL, NULL, '2017-01-24 21:30:00', 'Generate Loan Loss ProvisioningJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(20, 'Post Dividends For Shares', 'Post Dividends For Shares', '0 0 0 1/1 * ? *', '2017-01-23 22:37:13', 5, NULL, NULL, '2017-01-24 21:30:00', 'Post Dividends For SharesJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(21, 'Update Savings Dormant Accounts', 'Update Savings Dormant Accounts', '0 0 0 1/1 * ? *', '2017-01-23 22:37:15', 3, NULL, NULL, '2017-01-24 21:30:00', 'Update Savings Dormant AccountsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 1, 0),
	(22, 'Add Accrual Transactions For Loans With Income Posted As Transactions', 'Add Accrual Transactions For Loans With Income Posted As Transactions', '0 1 0 1/1 * ? *', '2017-01-23 22:37:18', 5, NULL, NULL, '2017-01-24 21:31:00', 'Add Accrual Transactions For Loans With Income Posted As TransactionsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 3, 0),
	(23, 'Execute Report Mailing Jobs', 'Execute Report Mailing Jobs', '0 0/15 * * * ?', '2017-01-23 22:37:23', 5, NULL, '2017-01-24 08:30:00', '2017-01-24 08:45:00', 'Execute Report Mailing JobsJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0),
	(24, 'Update SMS Outbound with Campaign Message', 'Update SMS Outbound with Campaign Message', '0 0 5 1/1 * ? *', '2017-01-23 22:37:26', 3, NULL, '2017-01-24 08:27:08', '2017-01-25 02:30:00', 'Update SMS Outbound with Campaign MessageJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 4, 0),
	(25, 'Send Messages to SMS Gateway', 'Send Messages to SMS Gateway', '0 0 5 1/1 * ? *', '2017-01-23 22:37:26', 2, NULL, '2017-01-24 08:27:09', '2017-01-25 02:30:00', 'Send Messages to SMS GatewayJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 4, 0),
	(26, 'Get Delivery Reports from SMS Gateway', 'Get Delivery Reports from SMS Gateway', '0 0 5 1/1 * ? *', '2017-01-23 22:37:26', 1, NULL, '2017-01-24 08:27:20', '2017-01-25 02:30:00', 'Get Delivery Reports from SMS GatewayJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 4, 0);
...
-- Dumping data for table mifostenant-default.job_run_history: ~14 rows (approximately)
...
INSERT INTO `job_run_history` (`id`, `job_id`, `version`, `start_time`, `end_time`, `status`, `error_message`, `trigger_type`, `error_log`) VALUES
	(1, 23, 1, '2017-01-23 22:45:00', '2017-01-23 22:45:00', 'success', NULL, 'cron', NULL),
	(2, 23, 2, '2017-01-23 23:00:00', '2017-01-23 23:00:00', 'success', NULL, 'cron', NULL),
	(3, 23, 3, '2017-01-23 23:15:00', '2017-01-23 23:15:00', 'success', NULL, 'cron', NULL),
	(4, 23, 4, '2017-01-23 23:30:00', '2017-01-23 23:30:00', 'success', NULL, 'cron', NULL),
	(5, 23, 5, '2017-01-23 23:45:00', '2017-01-23 23:45:00', 'success', NULL, 'cron', NULL),
	(6, 23, 6, '2017-01-24 00:00:00', '2017-01-24 00:00:00', 'success', NULL, 'cron', NULL),
	(7, 23, 7, '2017-01-24 00:15:00', '2017-01-24 00:15:00', 'success', NULL, 'cron', NULL),
	(8, 23, 8, '2017-01-24 00:30:00', '2017-01-24 00:30:00', 'success', NULL, 'cron', NULL),
	(9, 23, 9, '2017-01-24 00:45:00', '2017-01-24 00:45:00', 'success', NULL, 'cron', NULL),
	(10, 24, 1, '2017-01-24 08:27:08', '2017-01-24 08:27:09', 'success', NULL, 'cron', NULL),
	(11, 23, 10, '2017-01-24 08:27:17', '2017-01-24 08:27:18', 'success', NULL, 'cron', NULL),
	(12, 25, 1, '2017-01-24 08:27:09', '2017-01-24 08:27:20', 'success', NULL, 'cron', NULL),
	(13, 26, 1, '2017-01-24 08:27:20', '2017-01-24 08:27:21', 'success', NULL, 'cron', NULL),
	(14, 23, 11, '2017-01-24 08:30:00', '2017-01-24 08:30:00', 'success', NULL, 'cron', NULL);
...
INSERT INTO `m_appuser` (`id`, `is_deleted`, `office_id`, `staff_id`, `username`, `firstname`, `lastname`, `password`, `email`, `firsttime_login_remaining`, `nonexpired`, `nonlocked`, `nonexpired_credentials`, `enabled`, `last_time_password_updated`, `password_never_expires`, `is_self_service_user`) VALUES
	(1, 0, 1, NULL, 'mifos', 'App', 'Administrator', '5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a', 'demomfi@mifos.org', b'0', b'1', b'1', b'1', b'1', '2017-01-23', 0, b'0'),
...
DELETE FROM `m_client_charge_paid_by`;
...
DELETE FROM `m_client_transaction`;
...
DELETE FROM `m_deposit_account_on_hold_transaction`;
...
DELETE FROM `m_entity_datatable_check`;
...
DELETE FROM `m_entity_to_entity_access`;
...
DELETE FROM `m_entity_to_entity_mapping`;
...
DELETE FROM `m_field_configuration`;
...
DELETE FROM `m_floating_rates_periods`;
...
DELETE FROM `m_hook_configuration`;
...
DELETE FROM `m_hook_registered_events`;
...
DELETE FROM `m_loanproduct_provisioning_entry`;
...
DELETE FROM `m_loanproduct_provisioning_mapping`;
...
DELETE FROM `m_loan_reschedule_request_term_variations_mapping`;
...
DELETE FROM `m_loan_tranche_charges`;
...
DELETE FROM `m_password_validation_policy`;
...
INSERT INTO `m_permission` (`id`, `grouping`, `code`, `entity_name`, `action_name`, `can_maker_checker`) VALUES
	...
	(767, 'report', 'READ_Daily Teller Cash Report (Pentaho)', 'Daily Teller Cash Report (Pentaho)', 'READ', 0);
...
DELETE FROM `m_product_loan_configurable_attributes`;
...
DELETE FROM `m_product_loan_floating_rates`;
...
DELETE FROM `m_product_loan_guarantee_details`;
...
DELETE FROM `m_product_loan_recalculation_details`;
...
DELETE FROM `m_product_loan_variable_installment_config`;
...
DELETE FROM `m_provisioning_criteria`;
...
DELETE FROM `m_provisioning_criteria_definition`;
...
DELETE FROM `m_provisioning_history`;
...
DELETE FROM `m_provision_category`;
...
DELETE FROM `m_report_mailing_job`;
...
DELETE FROM `m_report_mailing_job_configuration`;
...
DELETE FROM `m_savings_officer_assignment_history`;
...
DELETE FROM `m_selfservice_beneficiaries_tpt`;
...
DELETE FROM `m_share_account_charge`;
...
DELETE FROM `m_share_account_charge_paid_by`;
...
DELETE FROM `m_share_account_dividend_details`;
...
DELETE FROM `m_share_account_transactions`;
...
DELETE FROM `m_share_product_charge`;
...
DELETE FROM `m_share_product_dividend_pay_out`;
...
DELETE FROM `m_share_product_market_price`;
...
DELETE FROM `m_staff_assignment_history`;
...
DELETE FROM `m_survey_components`;
...
DELETE FROM `m_survey_lookup_tables`;
...
DELETE FROM `m_survey_questions`;
...
DELETE FROM `m_survey_responses`;
...
DELETE FROM `m_tax_component_history`;
...
DELETE FROM `m_tax_group_mappings`;
...
-- Dumping data for table mifostenant-default.schema_version: ~317 rows (approximately)
...
INSERT INTO `schema_version` (`version_rank`, `installed_rank`, `version`, `description`, `type`, `script`, `checksum`, `installed_by`, `installed_on`, `execution_time`, `success`) VALUES
	(1, 1, '1', 'mifosplatform-core-ddl-latest', 'SQL', 'V1__mifosplatform-core-ddl-latest.sql', 955277628, 'root', '2017-01-23 22:34:53', 7528, 1),
	(10, 10, '10', 'interest-posting-fields-for-savings', 'SQL', 'V10__interest-posting-fields-for-savings.sql', -915121401, 'root', '2017-01-23 22:34:58', 689, 1),
	(100, 100, '100', 'Group saving summary report', 'SQL', 'V100__Group_saving_summary_report.sql', 1693648402, 'root', '2017-01-23 22:35:34', 30, 1),
	(101, 101, '101', 'add mulitplesof to account transfers table', 'SQL', 'V101__add_mulitplesof_to_account_transfers_table.sql', 1170497405, 'root', '2017-01-23 22:35:34', 343, 1),
	(102, 102, '102', 'client attendance tables', 'SQL', 'V102__client_attendance_tables.sql', 671600688, 'root', '2017-01-23 22:35:34', 191, 1),
	(103, 103, '103', 'cluster support for batch jobs', 'SQL', 'V103__cluster_support_for_batch_jobs.sql', -1003733401, 'root', '2017-01-23 22:35:35', 330, 1),
	(104, 104, '104', 'permissions for transfers', 'SQL', 'V104__permissions_for_transfers.sql', 2097086645, 'root', '2017-01-23 22:35:35', 33, 1),
	(105, 105, '105', 'track loan transaction against office', 'SQL', 'V105__track_loan_transaction_against_office.sql', -2088762881, 'root', '2017-01-23 22:35:36', 778, 1),
	(106, 106, '106', 'more permissions for transfers', 'SQL', 'V106__more_permissions_for_transfers.sql', 53789950, 'root', '2017-01-23 22:35:36', 14, 1),
	(107, 107, '107', 'datatable code mappings', 'SQL', 'V107__datatable_code_mappings.sql', 1936829107, 'root', '2017-01-23 22:35:36', 126, 1),
	(108, 108, '108', 'client has transfer office', 'SQL', 'V108__client_has_transfer_office.sql', 1848604685, 'root', '2017-01-23 22:35:37', 308, 1),
	(109, 109, '109', 'account transfer withdrawal fee configuration', 'SQL', 'V109__account_transfer_withdrawal_fee_configuration.sql', -1509786056, 'root', '2017-01-23 22:35:37', 698, 1),
	(11, 11, '11', 'add-payment-details', 'SQL', 'V11__add-payment-details.sql', -2044785781, 'root', '2017-01-23 22:34:58', 547, 1),
	(110, 110, '110', 'group center close', 'SQL', 'V110__group_center_close.sql', -2002358105, 'root', '2017-01-23 22:35:38', 385, 1),
	(111, 111, '111', 'disable constraint approach for datatables by default', 'SQL', 'V111__disable_constraint_approach_for_datatables_by_default.sql', -1856221518, 'root', '2017-01-23 22:35:38', 35, 1),
	(112, 112, '111.1', 'set default transfers in suspense account for existing loan products', 'SQL', 'V111_1__set default_transfers_in_suspense_account_for_existing_loan_products.sql', -555049996, 'root', '2017-01-23 22:35:38', 6, 1),
	(113, 113, '112', 'mixreport sql support', 'SQL', 'V112__mixreport_sql_support.sql', -1634685996, 'root', '2017-01-23 22:35:39', 464, 1),
	(114, 114, '113', 'track savings transaction against office', 'SQL', 'V113__track_savings_transaction_against_office.sql', -1937464787, 'root', '2017-01-23 22:35:39', 865, 1),
	(115, 115, '114', 'set default transfers in suspense account for existing savings products - Copy', 'SQL', 'V114__set_default_transfers_in_suspense_account_for_existing_savings_products - Copy.sql', -171456457, 'root', '2017-01-23 22:35:40', 3, 1),
	(116, 116, '115', 'permissions for cache api', 'SQL', 'V115__permissions_for_cache_api.sql', 1158425551, 'root', '2017-01-23 22:35:40', 284, 1),
	(117, 117, '116', 'track currency for journal entries', 'SQL', 'V116__track_currency_for_journal_entries.sql', -532037257, 'root', '2017-01-23 22:35:41', 643, 1),
	(118, 118, '117', 'loan charge from savings', 'SQL', 'V117__loan_charge_from_savings.sql', 801798692, 'root', '2017-01-23 22:35:41', 713, 1),
	(119, 119, '118', 'savings charge', 'SQL', 'V118__savings_charge.sql', -593125861, 'root', '2017-01-23 22:35:42', 793, 1),
	(120, 120, '118.1', 'savings charge patch update', 'SQL', 'V118_1__savings_charge_patch_update.sql', 409219698, 'root', '2017-01-23 22:35:43', 281, 1),
	(121, 121, '118.2', 'product mapping delete duplicate fund source to account mappings', 'SQL', 'V118_2__product_mapping_delete_duplicate_fund_source_to_account_mappings.sql', 1393421535, 'root', '2017-01-23 22:35:43', 4, 1),
	(122, 122, '118.3', 'permissions form propose and accept client transfers', 'SQL', 'V118_3__permissions_form_propose_and_accept_client_transfers.sql', -1752486114, 'root', '2017-01-23 22:35:43', 13, 1),
	(123, 123, '118.4', 'reset default transfers in suspense account for existing savings products', 'SQL', 'V118_4__reset_default_transfers_in_suspense_account_for_existing_savings_products.sql', -1647024296, 'root', '2017-01-23 22:35:43', 5, 1),
	(124, 124, '118.5', 'batch job entry for pay savings charge', 'SQL', 'V118_5__batch_job_entry_for_pay_savings_charge.sql', -301143983, 'root', '2017-01-23 22:35:43', 13, 1),
	(125, 125, '118.6', 'defaults for income from penalties for savings product', 'SQL', 'V118_6__defaults_for_income_from_penalties_for savings_product.sql', -1821592388, 'root', '2017-01-23 22:35:43', 5, 1),
	(126, 126, '118.7', 'move withdrawal annual fee to charges', 'SQL', 'V118_7__move_withdrawal_annual_fee_to_charges.sql', -682159103, 'root', '2017-01-23 22:35:44', 1231, 1),
	(127, 127, '118.8', 'track overpayments seperately in loan transactions', 'SQL', 'V118_8__track_overpayments_seperately_in_loan_transactions.sql', 543900977, 'root', '2017-01-23 22:35:45', 211, 1),
	(128, 128, '119', 'add template table', 'SQL', 'V119__add_template_table.sql', 506250383, 'root', '2017-01-23 22:35:45', 358, 1),
	(12, 12, '12', 'add external id to couple of tables', 'SQL', 'V12__add_external_id_to_couple_of_tables.sql', 472305363, 'root', '2017-01-23 22:35:00', 1166, 1),
	(129, 129, '120', 'accounting running balance', 'SQL', 'V120__accounting_running_balance.sql', 2038578089, 'root', '2017-01-23 22:35:45', 200, 1),
	(130, 130, '121', 'accounting running balance for organization', 'SQL', 'V121__accounting_running_balance_for_organization.sql', 777437006, 'root', '2017-01-23 22:35:46', 198, 1),
	(131, 131, '122', 'recurring fee support for savings', 'SQL', 'V122__recurring_fee_support_for_savings.sql', 101575000, 'root', '2017-01-23 22:35:46', 430, 1),
	(132, 132, '123', 'remove payment mode for savings', 'SQL', 'V123__remove_payment_mode_for_savings.sql', 785052987, 'root', '2017-01-23 22:35:46', 159, 1),
	(133, 133, '124', 'added min max cap for charges', 'SQL', 'V124__added_min_max_cap_for_charges.sql', -513616995, 'root', '2017-01-23 22:35:47', 545, 1),
	(134, 134, '125', 'added column for actual fee amount or percentage', 'SQL', 'V125__added_column_for_actual_fee_amount_or_percentage.sql', -148629234, 'root', '2017-01-23 22:35:48', 292, 1),
	(135, 135, '126', 'initial database structure for sms outbound', 'SQL', 'V126__initial_database_structure_for_sms_outbound.sql', 537635250, 'root', '2017-01-23 22:35:48', 180, 1),
	(136, 136, '127', 'mobile no fields', 'SQL', 'V127__mobile_no_fields.sql', -1231855730, 'root', '2017-01-23 22:35:48', 518, 1),
	(137, 137, '128', 'added loan installment charge', 'SQL', 'V128__added_loan_installment_charge.sql', -2044492671, 'root', '2017-01-23 22:35:49', 115, 1),
	(138, 138, '129', 'client and group timeline', 'SQL', 'V129__client_and_group_timeline.sql', -334848964, 'root', '2017-01-23 22:35:50', 975, 1),
	(13, 13, '13', 'add group and client pending configuration', 'SQL', 'V13__add_group_and_client_pending_configuration.sql', 2017249783, 'root', '2017-01-23 22:35:00', 15, 1),
	(139, 139, '130', 'calendar-history-table', 'SQL', 'V130__calendar-history-table.sql', -1996204583, 'root', '2017-01-23 22:35:50', 134, 1),
	(140, 140, '131', 'holiday-status-column-and-permissions', 'SQL', 'V131__holiday-status-column-and-permissions.sql', -2109352908, 'root', '2017-01-23 22:35:50', 369, 1),
	(141, 141, '132', 'borrower cycle changes', 'SQL', 'V132__borrower_cycle_changes.sql', -238834331, 'root', '2017-01-23 22:35:51', 444, 1),
	(142, 142, '133', 'adding payment detail with journal entry', 'SQL', 'V133__adding_payment_detail_with_journal_entry.sql', -604769594, 'root', '2017-01-23 22:35:51', 269, 1),
	(143, 143, '134', 'added column value on c configuration', 'SQL', 'V134__added_column_value_on_c_configuration.sql', -1619312365, 'root', '2017-01-23 22:35:52', 248, 1),
	(144, 144, '134.1', 'submitted date updation for clients', 'SQL', 'V134_1__submitted_date_updation_for_clients.sql', -835307031, 'root', '2017-01-23 22:35:52', 6, 1),
	(145, 145, '134.2', 'permissions spelling correction', 'SQL', 'V134_2__permissions_spelling_correction.sql', -851162618, 'root', '2017-01-23 22:35:52', 15, 1),
	(146, 146, '135', 'added permission for undo written off', 'SQL', 'V135__added_permission_for_undo_written_off.sql', -147929633, 'root', '2017-01-23 22:35:52', 5, 1),
	(147, 147, '136.1', 'update script strechy parameter', 'SQL', 'V136_1__update_script_strechy_parameter.sql', 493289660, 'root', '2017-01-23 22:35:52', 16, 1),
	(148, 148, '137', 'added is active column in m staff', 'SQL', 'V137__added_is_active_column_in_m_staff.sql', -129240963, 'root', '2017-01-23 22:35:52', 255, 1),
	(149, 149, '138', 'add short name for m product loan and m savings product', 'SQL', 'V138__add_short_name_for_m_product_loan_and_m_savings_product.sql', 1111329012, 'root', '2017-01-23 22:35:54', 1075, 1),
	(150, 150, '139', 'default value for is active updated to true in m staff', 'SQL', 'V139__default_value_for_is_active_updated_to_true_in_m_staff.sql', 26619575, 'root', '2017-01-23 22:35:54', 157, 1),
	(14, 14, '14', 'rename status id to enum', 'SQL', 'V14__rename_status_id_to_enum.sql', 971956550, 'root', '2017-01-23 22:35:00', 79, 1),
	(151, 151, '140', 'added loan charge status', 'SQL', 'V140__added_loan_charge_status.sql', 1403135602, 'root', '2017-01-23 22:35:54', 216, 1),
	(152, 152, '140.1', 'added payment detail id in ac gl journal entry', 'SQL', 'V140_1__added_payment_detail_id_in_ac_gl_journal_entry.sql', -790452836, 'root', '2017-01-23 22:35:55', 367, 1),
	(153, 153, '141', 'add early repayment strategy', 'SQL', 'V141__add_early_repayment_strategy.sql', 1919258536, 'root', '2017-01-23 22:35:55', 15, 1),
	(154, 154, '142', 'read savingsaccount charge permission', 'SQL', 'V142__read_savingsaccount_charge_permission.sql', 445185341, 'root', '2017-01-23 22:35:55', 16, 1),
	(155, 155, '143', 'create journalentry checker permission', 'SQL', 'V143__create_journalentry_checker_permission.sql', -1667764144, 'root', '2017-01-23 22:35:55', 19, 1),
	(156, 156, '144', 'spelling mistake corrections', 'SQL', 'V144__spelling_mistake_corrections.sql', -795294413, 'root', '2017-01-23 22:35:55', 88, 1),
	(157, 157, '145', 'add force password reset in c configuration', 'SQL', 'V145__add_force_password_reset_in_c_configuration.sql', 450084438, 'root', '2017-01-23 22:35:56', 887, 1),
	(158, 158, '146', 'tranche loans', 'SQL', 'V146__tranche_loans.sql', -618374535, 'root', '2017-01-23 22:35:57', 1020, 1),
	(159, 159, '147', 'tranche loans column name changes', 'SQL', 'V147__tranche_loans_column_name_changes.sql', -486809945, 'root', '2017-01-23 22:35:57', 33, 1),
	(160, 160, '148', 'overdraft changes', 'SQL', 'V148__overdraft_changes.sql', -1245017565, 'root', '2017-01-23 22:35:59', 1244, 1),
	(161, 161, '149', 'add created date savings transaction', 'SQL', 'V149__add_created_date_savings_transaction.sql', -1464354272, 'root', '2017-01-23 22:35:59', 262, 1),
	(15, 15, '15', 'center permissions', 'SQL', 'V15__center_permissions.sql', -1652318947, 'root', '2017-01-23 22:35:00', 16, 1),
	(162, 162, '150', 'basic savings report', 'SQL', 'V150__basic_savings_report.sql', -367961884, 'root', '2017-01-23 22:36:00', 326, 1),
	(163, 163, '151', 'add default savings account to client', 'SQL', 'V151__add_default_savings_account_to_client.sql', 149734852, 'root', '2017-01-23 22:36:00', 453, 1),
	(164, 164, '152', 'added grace for over due', 'SQL', 'V152__added_grace_for_over_due.sql', 523114401, 'root', '2017-01-23 22:36:01', 574, 1),
	(165, 165, '153', 'Insert missed permissions', 'SQL', 'V153__Insert_missed_permissions.sql', -1668699248, 'root', '2017-01-23 22:36:01', 18, 1),
	(166, 166, '154', 'aging details', 'SQL', 'V154__aging_details.sql', 1490415344, 'root', '2017-01-23 22:36:01', 12, 1),
	(167, 167, '155', 'stretchy into pentaho', 'SQL', 'V155__stretchy_into_pentaho.sql', -1765542054, 'root', '2017-01-23 22:36:01', 116, 1),
	(168, 168, '156', 'added loan saving txns pentaho', 'SQL', 'V156__added_loan_saving_txns_pentaho.sql', -225558880, 'root', '2017-01-23 22:36:01', 20, 1),
	(169, 169, '157', 'overdue charge improvements', 'SQL', 'V157__overdue_charge_improvements.sql', 557269609, 'root', '2017-01-23 22:36:02', 284, 1),
	(170, 170, '158', 'dashboard and navigation queries', 'SQL', 'V158__dashboard_and_navigation_queries.sql', 260379293, 'root', '2017-01-23 22:36:02', 22, 1),
	(171, 171, '159', 'add transaction id column m portfolio command source', 'SQL', 'V159__add_transaction_id_column_m_portfolio_command_source.sql', 848049166, 'root', '2017-01-23 22:36:02', 337, 1),
	(16, 16, '16', 'drop min max column on loan table', 'SQL', 'V16__drop_min_max_column_on_loan_table.sql', -620841858, 'root', '2017-01-23 22:35:00', 313, 1),
	(172, 172, '160', 'standing instruction changes', 'SQL', 'V160__standing_instruction_changes.sql', 606544932, 'root', '2017-01-23 22:36:03', 961, 1),
	(173, 173, '160.2', 'Allow nullValue For principal on lonProduct', 'SQL', 'V160_2__Allow_nullValue_For_principal_on_lonProduct.sql', -1888713202, 'root', '2017-01-23 22:36:04', 292, 1),
	(174, 174, '161', 'added accrual batch job', 'SQL', 'V161__added_accrual_batch_job.sql', -2105048610, 'root', '2017-01-23 22:36:04', 424, 1),
	(175, 175, '162', 'overdue charge batch job', 'SQL', 'V162__overdue_charge_batch_job.sql', -1920617111, 'root', '2017-01-23 22:36:05', 24, 1),
	(176, 176, '163', 'added npa for loans', 'SQL', 'V163__added_npa_for_loans.sql', 1195630185, 'root', '2017-01-23 22:36:05', 564, 1),
	(177, 177, '164', 'fd and rd deposit tables', 'SQL', 'V164__fd_and_rd_deposit_tables.sql', 210228160, 'root', '2017-01-23 22:36:08', 2262, 1),
	(178, 178, '165', 'added permission for disburse to saving account', 'SQL', 'V165__added_permission_for_disburse_to_saving_account.sql', 1731284424, 'root', '2017-01-23 22:36:08', 21, 1),
	(179, 179, '166', 'added deposit amount to product term and preclosure', 'SQL', 'V166__added_deposit_amount_to_product_term_and_preclosure.sql', 1150192306, 'root', '2017-01-23 22:36:08', 461, 1),
	(180, 180, '167', 'added columns for writtenOff loans recovered', 'SQL', 'V167__added_columns_for_writtenOff_loans_recovered.sql', 2034680396, 'root', '2017-01-23 22:36:09', 309, 1),
	(181, 181, '168', 'added transfer fixed deposit interest to linked account', 'SQL', 'V168__added_transfer_fixed_deposit_interest_to_linked_account.sql', -15179921, 'root', '2017-01-23 22:36:09', 784, 1),
	(182, 182, '169', 'update dashboard reports to core reports use report to false', 'SQL', 'V169__update_dashboard_reports_to_core_reports_use_report_to_false.sql', 1893278432, 'root', '2017-01-23 22:36:10', 14, 1),
	(17, 17, '17', 'update stretchy reporting ddl', 'SQL', 'V17__update_stretchy_reporting_ddl.sql', 1950226573, 'root', '2017-01-23 22:35:02', 1380, 1),
	(183, 183, '170', 'update deposit accounts maturity details job', 'SQL', 'V170__update_deposit_accounts_maturity_details_job.sql', -1809175088, 'root', '2017-01-23 22:36:10', 14, 1),
	(184, 184, '171', 'added mandatory savings and rd changes', 'SQL', 'V171__added_mandatory_savings_and_rd_changes.sql', 1819723867, 'root', '2017-01-23 22:36:11', 1636, 1),
	(185, 185, '172', 'accounting changes for transfers', 'SQL', 'V172__accounting_changes_for_transfers.sql', 495285267, 'root', '2017-01-23 22:36:12', 174, 1),
	(186, 186, '173', 'ppi', 'SQL', 'V173__ppi.sql', -315832082, 'root', '2017-01-23 22:36:13', 919, 1),
	(187, 187, '174', 'remove interest accrual', 'SQL', 'V174__remove_interest_accrual.sql', -86335365, 'root', '2017-01-23 22:36:13', 4, 1),
	(188, 188, '175', 'added incentive interest rates', 'SQL', 'V175__added_incentive_interest_rates.sql', 477904540, 'root', '2017-01-23 22:36:15', 1873, 1),
	(189, 189, '176', 'updates to financial activity accounts', 'SQL', 'V176__updates_to_financial_activity_accounts.sql', -832139038, 'root', '2017-01-23 22:36:15', 472, 1),
	(190, 190, '177', 'cleanup for client incentives', 'SQL', 'V177__cleanup_for_client_incentives.sql', 1886371318, 'root', '2017-01-23 22:36:15', 23, 1),
	(191, 191, '178', 'updates to financial activity accounts pt2', 'SQL', 'V178__updates_to_financial_activity_accounts_pt2.sql', 1427890502, 'root', '2017-01-23 22:36:16', 21, 1),
	(192, 192, '179', 'updates to action names for maker checker permissions', 'SQL', 'V179__updates_to_action_names_for_maker_checker_permissions.sql', 1694854506, 'root', '2017-01-23 22:36:16', 18, 1),
	(18, 18, '18', 'update stretchy reporting reportSql', 'SQL', 'V18__update_stretchy_reporting_reportSql.sql', 897124129, 'root', '2017-01-23 22:35:02', 20, 1),
	(193, 193, '180', 'update report schemas for disbursed vs awaitingdisbursal and groupnamesbystaff', 'SQL', 'V180__update_report_schemas_for_disbursed_vs_awaitingdisbursal_and_groupnamesbystaff.sql', -1059355980, 'root', '2017-01-23 22:36:16', 14, 1),
	(194, 194, '181', 'standing instruction logging', 'SQL', 'V181__standing_instruction_logging.sql', 37469411, 'root', '2017-01-23 22:36:16', 90, 1),
	(195, 195, '182', 'added min required balance to savings product', 'SQL', 'V182__added_min_required_balance_to_savings_product.sql', 293816320, 'root', '2017-01-23 22:36:16', 524, 1),
	(196, 196, '183', 'added min balance for interest calculation', 'SQL', 'V183__added_min_balance_for_interest_calculation.sql', 1252599574, 'root', '2017-01-23 22:36:17', 677, 1),
	(197, 197, '184', 'update min required balance for savings product', 'SQL', 'V184__update_min_required_balance_for_savings_product.sql', 1944024143, 'root', '2017-01-23 22:36:18', 135, 1),
	(198, 198, '185', 'add accrual till date for periodic accrual', 'SQL', 'V185__add_accrual_till_date_for_periodic_accrual.sql', 880447122, 'root', '2017-01-23 22:36:18', 362, 1),
	(199, 199, '186', 'added periodic accrual job', 'SQL', 'V186__added_periodic_accrual_job.sql', 301104388, 'root', '2017-01-23 22:36:18', 37, 1),
	(200, 200, '187', 'added permission to periodic accrual', 'SQL', 'V187__added_permission_to_periodic_accrual.sql', -2074721454, 'root', '2017-01-23 22:36:18', 15, 1),
	(201, 201, '188', 'add savingscharge inactivate permissions', 'SQL', 'V188__add_savingscharge_inactivate_permissions.sql', -540669352, 'root', '2017-01-23 22:36:18', 206, 1),
	(202, 202, '189', 'm loan interest recalculation tables', 'SQL', 'V189__m_loan_interest_recalculation_tables.sql', -99299101, 'root', '2017-01-23 22:36:19', 936, 1),
	(19, 19, '19', 'report maintenance permissions', 'SQL', 'V19__report_maintenance_permissions.sql', 1970906090, 'root', '2017-01-23 22:35:02', 16, 1),
	(203, 203, '190', 'add associategroup disassociategroup permissions', 'SQL', 'V190__add_associategroup_disassociategroup_permissions.sql', 381935931, 'root', '2017-01-23 22:36:20', 17, 1),
	(204, 204, '191', 'update gl account increase size of name col', 'SQL', 'V191__update_gl_account_increase_size_of_name_col.sql', 1536985501, 'root', '2017-01-23 22:36:20', 277, 1),
	(205, 205, '192', 'interest recalculate job', 'SQL', 'V192__interest_recalculate_job.sql', 79432898, 'root', '2017-01-23 22:36:20', 18, 1),
	(206, 206, '193', 'added column joiningDate for staff', 'SQL', 'V193__added_column_joiningDate_for_staff.sql', -821872836, 'root', '2017-01-23 22:36:20', 208, 1),
	(207, 207, '194', 'added recalculatedInterestComponent for interest recalculation', 'SQL', 'V194__added_recalculatedInterestComponent_for_interest_recalculation.sql', -1166586891, 'root', '2017-01-23 22:36:21', 219, 1),
	(208, 208, '195', 'moved rest frequency to product level', 'SQL', 'V195__moved_rest_frequency_to_product_level.sql', -1160182665, 'root', '2017-01-23 22:36:21', 624, 1),
	(209, 209, '196', 'added loan running balance to transactions', 'SQL', 'V196__added_loan_running_balance_to_transactions.sql', 1409766476, 'root', '2017-01-23 22:36:22', 248, 1),
	(210, 210, '197', 'updated loan running balance of transactions', 'SQL', 'V197__updated_loan_running_balance_of_transactions.sql', 1635739572, 'root', '2017-01-23 22:36:22', 238, 1),
	(211, 211, '198', 'loan rescheduling tables and permissions', 'SQL', 'V198__loan_rescheduling_tables_and_permissions.sql', -1766835098, 'root', '2017-01-23 22:36:23', 758, 1),
	(212, 212, '199', 'removed extra columns from schedule history', 'SQL', 'V199__removed_extra_columns_from_schedule_history.sql', -1832514885, 'root', '2017-01-23 22:36:23', 261, 1),
	(2, 2, '2', 'mifosx-base-reference-data-utf8', 'SQL', 'V2__mifosx-base-reference-data-utf8.sql', -1196210340, 'root', '2017-01-23 22:34:53', 164, 1),
	(20, 20, '20', 'report maint perms really configuration', 'SQL', 'V20__report_maint_perms_really_configuration.sql', 453012588, 'root', '2017-01-23 22:35:02', 11, 1),
	(213, 213, '200', 'alter savings account for start interest calculation date', 'SQL', 'V200__alter_savings_account_for_start_interest_calculation_date.sql', -1163540853, 'root', '2017-01-23 22:36:24', 303, 1),
	(214, 214, '201', 'webhooks', 'SQL', 'V201__webhooks.sql', 2049033132, 'root', '2017-01-23 22:36:25', 588, 1),
	(215, 215, '202', 'savings officer history table', 'SQL', 'V202__savings_officer_history_table.sql', 1234668850, 'root', '2017-01-23 22:36:25', 164, 1),
	(216, 216, '203', 'added subbmittedDate loantransaction', 'SQL', 'V203__added_subbmittedDate_loantransaction.sql', -1629312170, 'root', '2017-01-23 22:36:25', 494, 1),
	(217, 217, '204', 'insert script for charges paid by for accruals', 'SQL', 'V204__insert_script_for_charges_paid_by_for_accruals.sql', 795810978, 'root', '2017-01-23 22:36:26', 11, 1),
	(218, 218, '205', 'fix for charge and interest waiver with accruals', 'SQL', 'V205__fix_for_charge_and_interest_waiver_with_accruals.sql', 1503546394, 'root', '2017-01-23 22:36:26', 687, 1),
	(219, 219, '206', 'interest posting configuration', 'SQL', 'V206__interest_posting_configuration.sql', 154771122, 'root', '2017-01-23 22:36:27', 325, 1),
	(220, 220, '207', 'min max clients per group', 'SQL', 'V207__min_max_clients_per_group.sql', 184134907, 'root', '2017-01-23 22:36:27', 354, 1),
	(221, 221, '208', 'min max clients in group redux', 'SQL', 'V208__min_max_clients_in_group_redux.sql', -928317934, 'root', '2017-01-23 22:36:28', 319, 1),
	(222, 222, '209', 'add all report names in m permission table', 'SQL', 'V209__add_all_report_names_in_m_permission_table.sql', -365542947, 'root', '2017-01-23 22:36:28', 50, 1),
	(21, 21, '21', 'activation-permissions-for-clients', 'SQL', 'V21__activation-permissions-for-clients.sql', -247109946, 'root', '2017-01-23 22:35:03', 351, 1),
	(223, 223, '210', 'track manually adjusted transactions', 'SQL', 'V210__track_manually_adjusted_transactions.sql', 1826188666, 'root', '2017-01-23 22:36:28', 427, 1),
	(224, 224, '211', 'minimum days between disbursal and first repayment', 'SQL', 'V211__minimum_days_between_disbursal_and_first_repayment.sql', -1661038663, 'root', '2017-01-23 22:36:29', 352, 1),
	(225, 225, '212', 'add NthDay and DayOfWeek columns loan', 'SQL', 'V212__add_NthDay_and_DayOfWeek_columns_loan.sql', -604136808, 'root', '2017-01-23 22:36:30', 445, 1),
	(226, 226, '213', 'NthDay and DayOfWeek columns should be nullable', 'SQL', 'V213__NthDay_and_DayOfWeek_columns_should_be_nullable.sql', -467766587, 'root', '2017-01-23 22:36:30', 273, 1),
	(227, 227, '214', 'alter table add create SI at disbursement', 'SQL', 'V214__alter_table_add_create_SI_at_disbursement.sql', 634522786, 'root', '2017-01-23 22:36:31', 582, 1),
	(228, 228, '215', 'guarantee on hold fund changes', 'SQL', 'V215__guarantee_on_hold_fund_changes.sql', 150894107, 'root', '2017-01-23 22:36:32', 1080, 1),
	(229, 229, '216', 'adding loan proposed amount to loan', 'SQL', 'V216__adding_loan_proposed_amount_to_loan.sql', -1187625362, 'root', '2017-01-23 22:36:32', 287, 1),
	(230, 230, '217', 'client substatus and codevalue description', 'SQL', 'V217__client_substatus_and_codevalue_description.sql', 1580988935, 'root', '2017-01-23 22:36:33', 850, 1),
	(231, 231, '218', 'add user and datetime for loan savings transactions', 'SQL', 'V218__add_user_and_datetime_for_loan_savings_transactions.sql', 79809857, 'root', '2017-01-23 22:36:34', 676, 1),
	(232, 232, '219', 'guarantor on hold fund changes for account', 'SQL', 'V219__guarantor_on_hold_fund_changes_for_account.sql', 605515418, 'root', '2017-01-23 22:36:36', 1618, 1),
	(22, 22, '22', 'alter-group-for-consistency-add-permissions', 'SQL', 'V22__alter-group-for-consistency-add-permissions.sql', 1994886076, 'root', '2017-01-23 22:35:03', 653, 1),
	(233, 233, '220', 'account number preferences', 'SQL', 'V220__account_number_preferences.sql', 5010937, 'root', '2017-01-23 22:36:36', 157, 1),
	(234, 234, '221', 'add version for m savings account', 'SQL', 'V221__add_version_for_m_savings_account.sql', -458458210, 'root', '2017-01-23 22:36:36', 305, 1),
	(235, 235, '222', 'guarantor on hold fund changes for transactions', 'SQL', 'V222__guarantor_on_hold_fund_changes_for_transactions.sql', 1500152124, 'root', '2017-01-23 22:36:37', 1000, 1),
	(236, 236, '223', 'add version for m loan account', 'SQL', 'V223__add_version_for_m_loan_account.sql', 630974445, 'root', '2017-01-23 22:36:38', 476, 1),
	(237, 237, '224', 'client lifecycle adding statuses', 'SQL', 'V224__client_lifecycle_adding_statuses.sql', -1899179981, 'root', '2017-01-23 22:36:39', 1065, 1),
	(238, 238, '225', 'permissions for updating recurring deposit amount', 'SQL', 'V225__permissions_for_updating_recurring_deposit_amount.sql', -1994557062, 'root', '2017-01-23 22:36:39', 42, 1),
	(239, 239, '226', 'configuration for enforcing calendars for jlg loans', 'SQL', 'V226__configuration_for_enforcing_calendars_for_jlg_loans.sql', 1439092124, 'root', '2017-01-23 22:36:39', 13, 1),
	(240, 240, '227', 'loan-refund-permissions', 'SQL', 'V227__loan-refund-permissions.sql', -2112872726, 'root', '2017-01-23 22:36:40', 22, 1),
	(241, 241, '228', 'entity to entity access', 'SQL', 'V228__entity_to_entity_access.sql', -283406757, 'root', '2017-01-23 22:36:40', 208, 1),
	(242, 242, '229', 'teller cash management', 'SQL', 'V229__teller_cash_management.sql', -1424678232, 'root', '2017-01-23 22:36:41', 660, 1),
	(23, 23, '23', 'remove-enable-disable-configuration-for-client-group-status', 'SQL', 'V23__remove-enable-disable-configuration-for-client-group-status.sql', 267625051, 'root', '2017-01-23 22:35:04', 230, 1),
	(243, 243, '230', 'role status and correspoding permissions', 'SQL', 'V230__role_status_and_correspoding_permissions.sql', -11380981, 'root', '2017-01-23 22:36:41', 239, 1),
	(244, 244, '231', 'm cashier transaction added currency code', 'SQL', 'V231__m_cashier_transaction_added_currency_code.sql', 613838774, 'root', '2017-01-23 22:36:41', 199, 1),
	(245, 245, '232', 'insert center closure reason', 'SQL', 'V232__insert_center_closure_reason.sql', 1610893120, 'root', '2017-01-23 22:36:41', 22, 1),
	(246, 246, '233', 'Savings Transaction Receipt', 'SQL', 'V233__Savings_Transaction_Receipt.sql', -866032406, 'root', '2017-01-23 22:36:42', 19, 1),
	(247, 247, '234', 'opening balaces setup', 'SQL', 'V234__opening_balaces_setup.sql', 1086146792, 'root', '2017-01-23 22:36:42', 153, 1),
	(248, 248, '235', 'add ugd template id m hook', 'SQL', 'V235__add_ugd_template_id_m_hook.sql', -1822383963, 'root', '2017-01-23 22:36:43', 783, 1),
	(249, 249, '236', 'individual collection sheet permissions', 'SQL', 'V236__individual_collection_sheet_permissions.sql', 2002138461, 'root', '2017-01-23 22:36:43', 16, 1),
	(250, 250, '237', 'add threshold config for last instalment', 'SQL', 'V237__add_threshold_config_for_last_instalment.sql', -1244564740, 'root', '2017-01-23 22:36:43', 213, 1),
	(251, 251, '238', 'update staff display name length', 'SQL', 'V238__update_staff_display_name_length.sql', -2026750320, 'root', '2017-01-23 22:36:43', 175, 1),
	(252, 252, '239', 'Loan Transaction Receipt', 'SQL', 'V239__Loan_Transaction_Receipt.sql', -2048008570, 'root', '2017-01-23 22:36:44', 20, 1),
	(24, 24, '24', 'add-group-client-foreign-key-constraint-in-loan-table', 'SQL', 'V24__add-group-client-foreign-key-constraint-in-loan-table.sql', -895801251, 'root', '2017-01-23 22:35:04', 595, 1),
	(253, 253, '240', 'arrears aging config for interest recalculation', 'SQL', 'V240__arrears_aging_config_for_interest_recalculation.sql', -569040320, 'root', '2017-01-23 22:36:44', 600, 1),
	(254, 254, '241', 'fixed emi changes', 'SQL', 'V241__fixed_emi_changes.sql', 300787261, 'root', '2017-01-23 22:36:45', 359, 1),
	(255, 255, '242', 'entitytoentitymappingrelation', 'SQL', 'V242__entitytoentitymappingrelation.sql', 745908831, 'root', '2017-01-23 22:36:45', 208, 1),
	(256, 256, '243', 'alter loan disbursement details', 'SQL', 'V243__alter_loan_disbursement_details.sql', -1491848388, 'root', '2017-01-23 22:36:45', 157, 1),
	(257, 257, '244', 'staff assignment history table', 'SQL', 'V244__staff_assignment_history_table.sql', 18710234, 'root', '2017-01-23 22:36:46', 252, 1),
	(258, 258, '245', 'open rd changes', 'SQL', 'V245__open_rd_changes.sql', -2057800318, 'root', '2017-01-23 22:36:46', 15, 1),
	(259, 259, '246', 'drop group client foreign key from m loan', 'SQL', 'V246__drop_group_client_foreign_key_from_m_loan.sql', 1508935468, 'root', '2017-01-23 22:36:46', 32, 1),
	(260, 260, '247', 'consistency wrt spelling principalThresholdForLastInstalment', 'SQL', 'V247__consistency_wrt_spelling_principalThresholdForLastInstalment.sql', 682671217, 'root', '2017-01-23 22:36:46', 37, 1),
	(261, 261, '248', 'added password never expired to User', 'SQL', 'V248__added_password_never_expired_to_User.sql', 2112211436, 'root', '2017-01-23 22:36:46', 296, 1),
	(262, 262, '249', 'workingdays permissions', 'SQL', 'V249__workingdays_permissions.sql', 111355911, 'root', '2017-01-23 22:36:46', 11, 1),
	(25, 25, '25', 'update client reports for status and activation change', 'SQL', 'V25__update_client_reports_for_status_and_activation_change.sql', -156638565, 'root', '2017-01-23 22:35:04', 24, 1),
	(263, 263, '250', 'password validation policy', 'SQL', 'V250__password_validation_policy.sql', 625441779, 'root', '2017-01-23 22:36:47', 164, 1),
	(264, 264, '251', 'paymentType table', 'SQL', 'V251__paymentType_table.sql', -1153248008, 'root', '2017-01-23 22:36:48', 1048, 1),
	(265, 265, '252', 'bug fix teller cash management', 'SQL', 'V252__bug_fix_teller_cash_management.sql', -539616044, 'root', '2017-01-23 22:36:48', 382, 1),
	(266, 266, '253', 'product loan configurable attributes', 'SQL', 'V253__product_loan_configurable_attributes.sql', 611141994, 'root', '2017-01-23 22:36:48', 135, 1),
	(267, 267, '254', 'General Ledger Report', 'SQL', 'V254__General_Ledger_Report.sql', 2119102660, 'root', '2017-01-23 22:36:49', 24, 1),
	(268, 268, '255', 'pre close interest period config', 'SQL', 'V255__pre_close_interest_period_config.sql', 1808952818, 'root', '2017-01-23 22:36:49', 312, 1),
	(269, 269, '256', 'Update script for General Ledger report', 'SQL', 'V256__Update script for General_Ledger_report.sql', 696052144, 'root', '2017-01-23 22:36:49', 20, 1),
	(270, 270, '257', 'staff image association', 'SQL', 'V257__staff_image_association.sql', -836387316, 'root', '2017-01-23 22:36:50', 365, 1),
	(271, 271, '258', 'interest compounding changes', 'SQL', 'V258__interest_compounding_changes.sql', 360400057, 'root', '2017-01-23 22:36:50', 592, 1),
	(272, 272, '259', 'alter working days', 'SQL', 'V259__alter_working_days.sql', -1471987996, 'root', '2017-01-23 22:36:51', 354, 1),
	(26, 26, '26', 'add-support-for-withdrawal-fees-on-savings', 'SQL', 'V26__add-support-for-withdrawal-fees-on-savings.sql', 129901392, 'root', '2017-01-23 22:35:05', 859, 1),
	(273, 273, '260', 'alter password validation policy', 'SQL', 'V260__alter_password_validation_policy.sql', -1248692662, 'root', '2017-01-23 22:36:51', 343, 1),
	(274, 274, '261', 'Update script for Client Loan Account Schedule Report', 'SQL', 'V261__Update script for Client_Loan_Account_Schedule_Report.sql', 425432201, 'root', '2017-01-23 22:36:51', 64, 1),
	(275, 275, '262', 'accountNumber for groups', 'SQL', 'V262__accountNumber_for_groups.sql', 1922297099, 'root', '2017-01-23 22:36:52', 306, 1),
	(276, 276, '263', 'mifos reports', 'SQL', 'V263__mifos_reports.sql', 2128016331, 'root', '2017-01-23 22:36:52', 24, 1),
	(277, 277, '264', 'insert paymenttype and report read permission', 'SQL', 'V264__insert_paymenttype_and_report_read_permission.sql', -634268959, 'root', '2017-01-23 22:36:52', 12, 1),
	(278, 278, '265', 'modify external service schema', 'SQL', 'V265__modify_external_service_schema.sql', 300433155, 'root', '2017-01-23 22:36:54', 1563, 1),
	(279, 279, '266', 'client fees', 'SQL', 'V266__client_fees.sql', 1859569785, 'root', '2017-01-23 22:36:54', 436, 1),
	(280, 280, '267', 'client transaction permissions', 'SQL', 'V267__client_transaction_permissions.sql', 731273171, 'root', '2017-01-23 22:36:54', 16, 1),
	(281, 281, '268', 'update gmail password', 'SQL', 'V268__update_gmail_password.sql', 1571111604, 'root', '2017-01-23 22:36:54', 51, 1),
	(282, 282, '269', 'increased calendar title length ', 'SQL', 'V269__increased_calendar_title_length .sql', 1602892066, 'root', '2017-01-23 22:36:55', 64, 1),
	(27, 27, '27', 'add-loan-type-column-to-loan-table', 'SQL', 'V27__add-loan-type-column-to-loan-table.sql', 612867183, 'root', '2017-01-23 22:35:06', 376, 1),
	(283, 283, '270', 'add rounding mode configuration', 'SQL', 'V270__add_rounding_mode_configuration.sql', 1970738261, 'root', '2017-01-23 22:36:55', 261, 1),
	(284, 284, '271', 'accounting for client charges', 'SQL', 'V271__accounting_for_client_charges.sql', 1964981050, 'root', '2017-01-23 22:36:56', 803, 1),
	(285, 285, '272', 'loan tranche disbursement charge', 'SQL', 'V272__loan_tranche_disbursement_charge.sql', 1144829058, 'root', '2017-01-23 22:36:57', 1317, 1),
	(286, 286, '273', 'oauth changes', 'SQL', 'V273__oauth_changes.sql', -245059913, 'root', '2017-01-23 22:36:58', 257, 1),
	(287, 287, '274', 'Loan Reschedule Code Value', 'SQL', 'V274__Loan_Reschedule_Code_Value.sql', -5117183, 'root', '2017-01-23 22:36:58', 7, 1),
	(288, 288, '275', 'loan transaction to repayment schedule mapping', 'SQL', 'V275__loan_transaction_to_repayment_schedule_mapping.sql', -221403658, 'root', '2017-01-23 22:36:58', 103, 1),
	(289, 289, '276', 'loan recalulated till date', 'SQL', 'V276__loan_recalulated_till_date.sql', 16474746, 'root', '2017-01-23 22:36:58', 421, 1),
	(290, 290, '277', 'Loan Product Provisioning', 'SQL', 'V277__Loan_Product_Provisioning.sql', -391952085, 'root', '2017-01-23 22:36:59', 800, 1),
	(291, 291, '278', 'LoanTransactionProcessingStrategy', 'SQL', 'V278__LoanTransactionProcessingStrategy.sql', -237974347, 'root', '2017-01-23 22:37:00', 525, 1),
	(292, 292, '279', 'floating rates', 'SQL', 'V279__floating_rates.sql', -500468035, 'root', '2017-01-23 22:37:02', 1552, 1),
	(28, 28, '28', 'accounting-abstractions-and-autoposting', 'SQL', 'V28__accounting-abstractions-and-autoposting.sql', -2064898972, 'root', '2017-01-23 22:35:06', 305, 1),
	(293, 293, '280', 'spm framework initial tables', 'SQL', 'V280__spm_framework_initial_tables.sql', -912305200, 'root', '2017-01-23 22:37:03', 895, 1),
	(294, 294, '281', 'add configuration param backdate-penalties', 'SQL', 'V281__add_configuration_param_backdate-penalties.sql', -1810298086, 'root', '2017-01-23 22:37:03', 17, 1),
	(295, 295, '282', 'CustomerSelfService', 'SQL', 'V282__CustomerSelfService.sql', 240551284, 'root', '2017-01-23 22:37:03', 395, 1),
	(296, 296, '283', 'Variable Installments', 'SQL', 'V283__Variable_Installments.sql', -1494982036, 'root', '2017-01-23 22:37:04', 748, 1),
	(297, 297, '284', 'update codevalue', 'SQL', 'V284__update_codevalue.sql', -880137513, 'root', '2017-01-23 22:37:05', 464, 1),
	(298, 298, '285', 'undo last tranche script', 'SQL', 'V285__undo_last_tranche_script.sql', -691462674, 'root', '2017-01-23 22:37:05', 31, 1),
	(299, 299, '286', 'partial period interest calcualtion', 'SQL', 'V286__partial_period_interest_calcualtion.sql', 2098674974, 'root', '2017-01-23 22:37:06', 607, 1),
	(300, 300, '287', 'alter spm scorecard', 'SQL', 'V287__alter_spm_scorecard.sql', -1380609770, 'root', '2017-01-23 22:37:06', 141, 1),
	(301, 301, '288', 'overdraft interest', 'SQL', 'V288__overdraft_interest.sql', -1725673774, 'root', '2017-01-23 22:37:06', 503, 1),
	(302, 302, '289', 'client non person', 'SQL', 'V289__client_non_person.sql', -961697782, 'root', '2017-01-23 22:37:07', 660, 1),
	(29, 29, '29', 'add-support-for-annual-fees-on-savings', 'SQL', 'V29__add-support-for-annual-fees-on-savings.sql', -995632079, 'root', '2017-01-23 22:35:07', 672, 1),
	(303, 303, '290', 'shares dividends permissions script', 'SQL', 'V290__shares_dividends_permissions_script.sql', 146587860, 'root', '2017-01-23 22:37:07', 12, 1),
	(304, 304, '291', 'organisation start date config', 'SQL', 'V291__organisation_start_date_config.sql', -1674309950, 'root', '2017-01-23 22:37:08', 326, 1),
	(305, 305, '292', 'update organisation start date', 'SQL', 'V292__update_organisation_start_date.sql', 2016095558, 'root', '2017-01-23 22:37:08', 23, 1),
	(306, 306, '293', 'interest rate chart support for amounts', 'SQL', 'V293__interest_rate_chart_support_for_amounts.sql', -1720908295, 'root', '2017-01-23 22:37:09', 921, 1),
	(307, 307, '294', 'configuration for paymnettype application forDisbursement charge', 'SQL', 'V294__configuration_for_paymnettype_application_forDisbursement_charge.sql', -754382065, 'root', '2017-01-23 22:37:09', 16, 1),
	(308, 308, '295', 'configuration for interest charged date same as disbursal date', 'SQL', 'V295__configuration_for_interest_charged_date_same_as_disbursal_date.sql', -1113285243, 'root', '2017-01-23 22:37:09', 12, 1),
	(309, 309, '296', 'skip repayment on first-day of month', 'SQL', 'V296__skip_repayment_on first-day_of_month.sql', -172630113, 'root', '2017-01-23 22:37:09', 12, 1),
	(310, 310, '297', 'Adding Meeting Time column', 'SQL', 'V297__Adding_Meeting_Time_column.sql', -637673654, 'root', '2017-01-23 22:37:09', 164, 1),
	(311, 311, '298', 'savings interest tax', 'SQL', 'V298__savings_interest_tax.sql', -1023309693, 'root', '2017-01-23 22:37:11', 1786, 1),
	(312, 312, '299', 'share products', 'SQL', 'V299__share_products.sql', 1270845438, 'root', '2017-01-23 22:37:13', 2060, 1),
	(3, 3, '3', 'mifosx-permissions-and-authorisation-utf8', 'SQL', 'V3__mifosx-permissions-and-authorisation-utf8.sql', 656939441, 'root', '2017-01-23 22:34:53', 89, 1),
	(30, 30, '30', 'add-referenceNumber-to-acc gl journal entry', 'SQL', 'V30__add-referenceNumber-to-acc_gl_journal_entry.sql', 931391195, 'root', '2017-01-23 22:35:07', 298, 1),
	(313, 313, '300', 'configuration for allow changing of emi amount', 'SQL', 'V300__configuration_for_allow_changing_of_emi_amount.sql', -490331317, 'root', '2017-01-23 22:37:14', 494, 1),
	(314, 314, '301', 'recurring moratorium principal periods', 'SQL', 'V301__recurring_moratorium_principal_periods.sql', 816871436, 'root', '2017-01-23 22:37:15', 666, 1),
	(315, 315, '302', 'add status to client identifier', 'SQL', 'V302__add_status_to_client_identifier.sql', 1978862509, 'root', '2017-01-23 22:37:15', 188, 1),
	(316, 316, '303', 'Savings Account Dormancy', 'SQL', 'V303__Savings_Account_Dormancy.sql', -533139714, 'root', '2017-01-23 22:37:15', 441, 1),
	(317, 317, '304', 'customer self service third party transfers', 'SQL', 'V304__customer_self_service_third_party_transfers.sql', -341614071, 'root', '2017-01-23 22:37:16', 121, 1),
	(318, 318, '305', 'compounding and rest frequency nth day freq and insertion script for accrual job', 'SQL', 'V305__compounding_and_rest_frequency_nth_day_freq_and_insertion_script_for_accrual_job.sql', 710584648, 'root', '2017-01-23 22:37:18', 1879, 1),
	(319, 319, '306', 'add domancy tracking job to savings group', 'SQL', 'V306__add_domancy_tracking_job_to_savings_group.sql', -2998873, 'root', '2017-01-23 22:37:18', 14, 1),
	(320, 320, '307', 'add share notes', 'SQL', 'V307__add_share_notes.sql', -1950926410, 'root', '2017-01-23 22:37:18', 377, 1),
	(321, 321, '308', 'add interest recalculation in savings account', 'SQL', 'V308__add_interest_recalculation_in_savings_account.sql', 1869901088, 'root', '2017-01-23 22:37:19', 320, 1),
	(322, 322, '309', 'add loan write off reason code', 'SQL', 'V309__add_loan_write_off_reason_code.sql', 1221434865, 'root', '2017-01-23 22:37:19', 435, 1),
	(31, 31, '31', 'drop-autopostings', 'SQL', 'V31__drop-autopostings.sql', 1482958085, 'root', '2017-01-23 22:35:08', 73, 1),
	(323, 323, '310', 'copy data from entitytoentityaccess to entitytoentitymapping', 'SQL', 'V310__copy_data_from_entitytoentityaccess_to_entitytoentitymapping.sql', 1179078728, 'root', '2017-01-23 22:37:19', 24, 1),
	(324, 324, '311', 'foreclosure details', 'SQL', 'V311__foreclosure_details.sql', 1236003234, 'root', '2017-01-23 22:37:20', 371, 1),
	(325, 325, '312', 'add is mandatory to code value', 'SQL', 'V312__add_is_mandatory_to_code_value.sql', -1943949742, 'root', '2017-01-23 22:37:20', 263, 1),
	(326, 326, '313', 'multi rescheduling script', 'SQL', 'V313__multi_rescheduling_script.sql', -1003845274, 'root', '2017-01-23 22:37:22', 1396, 1),
	(327, 327, '314', 'updating r enum table', 'SQL', 'V314__updating_r_enum_table.sql', 780881263, 'root', '2017-01-23 22:37:22', 65, 1),
	(328, 328, '315', 'add sync expected with disbursement date in m product loan', 'SQL', 'V315__add_sync_expected_with_disbursement_date_in_m_product_loan.sql', 553617808, 'root', '2017-01-23 22:37:22', 216, 1),
	(329, 329, '316', 'address module tables metadat', 'SQL', 'V316__address_module_tables_metadat.sql', -776128404, 'root', '2017-01-23 22:37:23', 454, 1),
	(330, 330, '317', 'report mailing job module', 'SQL', 'V317__report_mailing_job_module.sql', -1917516805, 'root', '2017-01-23 22:37:23', 595, 1),
	(331, 331, '318', 'topuploan', 'SQL', 'V318__topuploan.sql', 590465441, 'root', '2017-01-23 22:37:25', 1007, 1),
	(332, 332, '319', 'client undoreject', 'SQL', 'V319__client_undoreject.sql', -1615618857, 'root', '2017-01-23 22:37:25', 604, 1),
	(32, 32, '32', 'associate-disassociate-clients-from-group-permissions', 'SQL', 'V32__associate-disassociate-clients-from-group-permissions.sql', -494472694, 'root', '2017-01-23 22:35:08', 29, 1),
	(333, 333, '320', 'add holiday payment reschedule', 'SQL', 'V320__add_holiday_payment_reschedule.sql', 1445492229, 'root', '2017-01-23 22:37:26', 259, 1),
	(334, 334, '321', 'boolean field As Interest PostedOn', 'SQL', 'V321__boolean_field_As_Interest_PostedOn.sql', 1906735834, 'root', '2017-01-23 22:37:26', 287, 1),
	(335, 335, '322', 'sms campaign', 'SQL', 'V322__sms_campaign.sql', -1316831815, 'root', '2017-01-23 22:37:27', 658, 1),
	(336, 336, '323', 'spm replace dead fk with exisiting one', 'SQL', 'V323__spm_replace_dead_fk_with_exisiting_one.sql', 656055500, 'root', '2017-01-23 22:37:27', 150, 1),
	(337, 337, '324', 'datatable checks', 'SQL', 'V324__datatable_checks.sql', -142308095, 'root', '2017-01-23 22:37:27', 136, 1),
	(33, 33, '33', 'drop unique check on stretchy report parameter', 'SQL', 'V33__drop_unique_check_on_stretchy_report_parameter.sql', 594468369, 'root', '2017-01-23 22:35:08', 45, 1),
	(34, 34, '34', 'add unique check on stretchy report parameter', 'SQL', 'V34__add_unique_check_on_stretchy_report_parameter.sql', -174129685, 'root', '2017-01-23 22:35:08', 107, 1),
	(35, 35, '35', 'add hierarchy column for acc gl account', 'SQL', 'V35__add_hierarchy_column_for_acc_gl_account.sql', 1606939439, 'root', '2017-01-23 22:35:08', 234, 1),
	(36, 36, '36', 'add tag id column for acc gl account', 'SQL', 'V36__add_tag_id_column_for_acc_gl_account.sql', -1913861595, 'root', '2017-01-23 22:35:09', 485, 1),
	(37, 37, '37', 'add-center-group-collection-sheet-permissions', 'SQL', 'V37__add-center-group-collection-sheet-permissions.sql', -1387816026, 'root', '2017-01-23 22:35:09', 20, 1),
	(38, 38, '38', 'add-group-summary-details-report', 'SQL', 'V38__add-group-summary-details-report.sql', -734381577, 'root', '2017-01-23 22:35:09', 13, 1),
	(39, 39, '39', 'payment-channels-updates', 'SQL', 'V39__payment-channels-updates.sql', -1060218860, 'root', '2017-01-23 22:35:10', 1146, 1),
	(4, 4, '4', 'mifosx-core-reports-utf8', 'SQL', 'V4__mifosx-core-reports-utf8.sql', 1938269916, 'root', '2017-01-23 22:34:54', 492, 1),
	(40, 40, '40', 'add permissions for accounting rule', 'SQL', 'V40__add_permissions_for_accounting_rule.sql', -116179709, 'root', '2017-01-23 22:35:10', 11, 1),
	(41, 41, '41', 'group-summary-reports', 'SQL', 'V41__group-summary-reports.sql', -772715166, 'root', '2017-01-23 22:35:10', 17, 1),
	(42, 42, '42', 'Add default value for id for acc accounting rule', 'SQL', 'V42__Add_default_value_for_id_for_acc_accounting_rule.sql', 604918027, 'root', '2017-01-23 22:35:11', 287, 1),
	(43, 43, '43', 'accounting-for-savings', 'SQL', 'V43__accounting-for-savings.sql', -1500414425, 'root', '2017-01-23 22:35:11', 580, 1),
	(44, 44, '44', 'document-increase-size-of-column-type', 'SQL', 'V44__document-increase-size-of-column-type.sql', -1050476515, 'root', '2017-01-23 22:35:12', 296, 1),
	(45, 45, '45', 'create acc rule tags table', 'SQL', 'V45__create_acc_rule_tags_table.sql', 1162013385, 'root', '2017-01-23 22:35:12', 97, 1),
	(46, 46, '46', 'extend datatables api', 'SQL', 'V46__extend_datatables_api.sql', 1411386919, 'root', '2017-01-23 22:35:12', 13, 1),
	(47, 47, '47', 'staff-hierarchy-link-to-users', 'SQL', 'V47__staff-hierarchy-link-to-users.sql', 1889695678, 'root', '2017-01-23 22:35:13', 1075, 1),
	(48, 48, '48', 'adding-S3-Support', 'SQL', 'V48__adding-S3-Support.sql', 1203678485, 'root', '2017-01-23 22:35:15', 1231, 1),
	(49, 49, '49', 'track-loan-charge-payment-transactions', 'SQL', 'V49__track-loan-charge-payment-transactions.sql', 545881620, 'root', '2017-01-23 22:35:15', 230, 1),
	(5, 5, '5', 'update-savings-product-and-account-tables', 'SQL', 'V5__update-savings-product-and-account-tables.sql', -1335665240, 'root', '2017-01-23 22:34:55', 514, 1),
	(50, 50, '50', 'add-grace-settings-to-loan-product', 'SQL', 'V50__add-grace-settings-to-loan-product.sql', 781542044, 'root', '2017-01-23 22:35:16', 646, 1),
	(338, 338, '5000', 'Daily Teller Cash Report pentaho', 'SQL', 'V5000__Daily_Teller_Cash_Report_pentaho.sql', -638871297, 'root', '2017-01-23 22:37:27', 31, 1),
	(51, 51, '51', 'track-additional-details-related-to-installment-performance', 'SQL', 'V51__track-additional-details-related-to-installment-performance.sql', 1877290988, 'root', '2017-01-23 22:35:16', 318, 1),
	(52, 52, '52', 'add boolean support cols to acc accounting rule', 'SQL', 'V52__add_boolean_support_cols_to_acc_accounting_rule.sql', -1027998479, 'root', '2017-01-23 22:35:16', 322, 1),
	(53, 53, '53', 'track-advance-and-late-payments-on-installment', 'SQL', 'V53__track-advance-and-late-payments-on-installment.sql', 1329153113, 'root', '2017-01-23 22:35:17', 531, 1),
	(54, 54, '54', 'charge-to-income-account-mappings', 'SQL', 'V54__charge-to-income-account-mappings.sql', -407918884, 'root', '2017-01-23 22:35:17', 274, 1),
	(55, 55, '55', 'add-additional-transaction-processing-strategies', 'SQL', 'V55__add-additional-transaction-processing-strategies.sql', 431870896, 'root', '2017-01-23 22:35:18', 312, 1),
	(56, 56, '56', 'track-overpaid-amount-on-loans', 'SQL', 'V56__track-overpaid-amount-on-loans.sql', -1032410124, 'root', '2017-01-23 22:35:18', 261, 1),
	(57, 57, '57', 'add default values to debit and credit accounts acc accounting rule', 'SQL', 'V57__add_default_values_to_debit_and_credit_accounts_acc_accounting_rule.sql', 235706681, 'root', '2017-01-23 22:35:18', 201, 1),
	(58, 58, '58', 'create-holiday-tables changed', 'SQL', 'V58__create-holiday-tables_changed.sql', 1656341096, 'root', '2017-01-23 22:35:19', 300, 1),
	(59, 59, '59', 'add group roles schema and permissions', 'SQL', 'V59__add_group_roles_schema_and_permissions.sql', 755577759, 'root', '2017-01-23 22:35:19', 161, 1),
	(6, 6, '6', 'add min max principal column to loan', 'SQL', 'V6__add_min_max_principal_column_to_loan.sql', 1691311198, 'root', '2017-01-23 22:34:55', 837, 1),
	(60, 60, '60', 'quipo dashboard reports', 'SQL', 'V60__quipo_dashboard_reports.sql', 1200522596, 'root', '2017-01-23 22:35:19', 44, 1),
	(61, 61, '61', 'txn running balance example', 'SQL', 'V61__txn_running_balance_example.sql', 1448824868, 'root', '2017-01-23 22:35:19', 22, 1),
	(62, 62, '62', 'add staff id to m client changed', 'SQL', 'V62__add_staff_id_to_m_client_changed.sql', 1876751638, 'root', '2017-01-23 22:35:20', 385, 1),
	(63, 63, '63', 'add sync disbursement with meeting column to loan', 'SQL', 'V63__add_sync_disbursement_with_meeting_column_to_loan.sql', -668764096, 'root', '2017-01-23 22:35:20', 385, 1),
	(64, 64, '64', 'add permission for assign staff', 'SQL', 'V64__add_permission_for_assign_staff.sql', -1177097659, 'root', '2017-01-23 22:35:20', 15, 1),
	(65, 65, '65', 'fix rupee symbol issues', 'SQL', 'V65__fix_rupee_symbol_issues.sql', -1194106354, 'root', '2017-01-23 22:35:20', 19, 1),
	(66, 66, '66', 'client close functionality', 'SQL', 'V66__client_close_functionality.sql', -1362214442, 'root', '2017-01-23 22:35:21', 581, 1),
	(67, 67, '67', 'loans in advance table', 'SQL', 'V67__loans_in_advance_table.sql', 29130560, 'root', '2017-01-23 22:35:21', 99, 1),
	(68, 68, '68', 'quipo dashboard reports updated', 'SQL', 'V68__quipo_dashboard_reports_updated.sql', -1865417462, 'root', '2017-01-23 22:35:21', 49, 1),
	(69, 69, '69', 'loans in advance initialise', 'SQL', 'V69__loans_in_advance_initialise.sql', 1132804183, 'root', '2017-01-23 22:35:21', 80, 1),
	(7, 7, '7', 'remove read makerchecker permission', 'SQL', 'V7__remove_read_makerchecker_permission.sql', -2078415771, 'root', '2017-01-23 22:34:56', 19, 1),
	(70, 70, '70', 'quipo program detail query fix', 'SQL', 'V70__quipo_program_detail_query_fix.sql', -1314752325, 'root', '2017-01-23 22:35:21', 16, 1),
	(71, 71, '71', 'insert reschedule repayment to configuration', 'SQL', 'V71__insert_reschedule_repayment_to_configuration.sql', -1744995263, 'root', '2017-01-23 22:35:21', 13, 1),
	(72, 72, '72', 'add m loan counter changes', 'SQL', 'V72__add_m_loan_counter_changes.sql', 1657331766, 'root', '2017-01-23 22:35:22', 333, 1),
	(73, 73, '73', 'add repayments rescheduled to and processed column to holiday', 'SQL', 'V73__add_repayments_rescheduled_to_and_processed_column_to_holiday.sql', 1126478114, 'root', '2017-01-23 22:35:22', 222, 1),
	(74, 74, '74', 'alter m loan counter table add group', 'SQL', 'V74__alter_m_loan_counter_table_add_group.sql', -1934237868, 'root', '2017-01-23 22:35:23', 611, 1),
	(75, 75, '75', 'add reschedule-repayments-on-holidays to configuration', 'SQL', 'V75__add_reschedule-repayments-on-holidays_to_configuration.sql', -1278134204, 'root', '2017-01-23 22:35:23', 15, 1),
	(76, 76, '76', 'rename permission grouping', 'SQL', 'V76__rename_permission_grouping.sql', -1636539309, 'root', '2017-01-23 22:35:23', 16, 1),
	(77, 77, '77', 'alter m product loan changes', 'SQL', 'V77__alter_m_product_loan_changes.sql', 1835358988, 'root', '2017-01-23 22:35:23', 181, 1),
	(78, 78, '78', 'breakdown portfolio grouping', 'SQL', 'V78__breakdown_portfolio_grouping.sql', -198729568, 'root', '2017-01-23 22:35:23', 13, 1),
	(79, 79, '79', 'schedule jobs tables', 'SQL', 'V79__schedule_jobs_tables.sql', 312120211, 'root', '2017-01-23 22:35:24', 198, 1),
	(8, 8, '8', 'deposit-transaction-permissions-if-they-exist', 'SQL', 'V8__deposit-transaction-permissions-if-they-exist.sql', 1801801284, 'root', '2017-01-23 22:34:56', 3, 1),
	(80, 80, '80', 'schedule jobs tables updates', 'SQL', 'V80__schedule_jobs_tables_updates.sql', -748120531, 'root', '2017-01-23 22:35:25', 1422, 1),
	(81, 81, '81', 'savings related changes', 'SQL', 'V81__savings_related_changes.sql', -888957999, 'root', '2017-01-23 22:35:27', 1482, 1),
	(82, 82, '82', 'schedule jobs tables updates for running status', 'SQL', 'V82__schedule_jobs_tables_updates_for_running_status.sql', 229481826, 'root', '2017-01-23 22:35:27', 595, 1),
	(83, 83, '83', 'non-working-days-table', 'SQL', 'V83__non-working-days-table.sql', 1881541622, 'root', '2017-01-23 22:35:28', 147, 1),
	(84, 84, '84', 'undo savings transaction permission', 'SQL', 'V84__undo_savings_transaction_permission.sql', -1779650707, 'root', '2017-01-23 22:35:28', 19, 1),
	(85, 85, '85', 'product mix related changes', 'SQL', 'V85__product_mix_related_changes.sql', -1468649166, 'root', '2017-01-23 22:35:28', 492, 1),
	(86, 86, '86', 'update-working-days', 'SQL', 'V86__update-working-days.sql', -1140835665, 'root', '2017-01-23 22:35:29', 87, 1),
	(87, 87, '87', 'add permission for scheduler', 'SQL', 'V87__add_permission_for_scheduler.sql', 1996443143, 'root', '2017-01-23 22:35:29', 80, 1),
	(88, 88, '88', 'added update constrain for scheduler jobs', 'SQL', 'V88__added_update_constrain_for_scheduler_jobs.sql', 777067784, 'root', '2017-01-23 22:35:29', 246, 1),
	(89, 89, '89', 'added scheduler group', 'SQL', 'V89__added_scheduler_group.sql', -2129901927, 'root', '2017-01-23 22:35:29', 217, 1),
	(9, 9, '9', 'add min max constraint column to loan loanproduct', 'SQL', 'V9__add_min_max_constraint_column_to_loan_loanproduct.sql', -518699440, 'root', '2017-01-23 22:34:57', 1363, 1),
	(90, 90, '90', 'client performance history reports', 'SQL', 'V90__client_performance_history_reports.sql', -140192401, 'root', '2017-01-23 22:35:29', 18, 1),
	(91, 91, '91', 'apply annual fees permission', 'SQL', 'V91__apply_annual_fees_permission.sql', 923770634, 'root', '2017-01-23 22:35:30', 11, 1),
	(92, 92, '91.1', 'configuration settings for holiday and non workingday', 'SQL', 'V91_1__configuration_settings_for_holiday_and_non_workingday.sql', -308211608, 'root', '2017-01-23 22:35:30', 13, 1),
	(93, 93, '92', 'group center assign staff permission', 'SQL', 'V92__group_center_assign_staff_permission.sql', -1774462272, 'root', '2017-01-23 22:35:30', 10, 1),
	(94, 94, '93', 'loan transaction external id', 'SQL', 'V93__loan_transaction_external_id.sql', 1057431340, 'root', '2017-01-23 22:35:30', 269, 1),
	(95, 95, '94', 'added savings accont type', 'SQL', 'V94__added_savings_accont type.sql', 652367910, 'root', '2017-01-23 22:35:30', 299, 1),
	(96, 96, '95', 'batch job postInterest', 'SQL', 'V95__batch_job_postInterest.sql', 597753088, 'root', '2017-01-23 22:35:30', 14, 1),
	(97, 97, '96', 'savings accounts transfers table', 'SQL', 'V96__savings_accounts_transfers_table.sql', 695072575, 'root', '2017-01-23 22:35:31', 425, 1),
	(98, 98, '97', 'add permission for adjust savings transaction', 'SQL', 'V97__add_permission_for_adjust_savings_transaction.sql', 103624768, 'root', '2017-01-23 22:35:31', 14, 1),
	(99, 99, '98', 'added currency roundof for multipleof', 'SQL', 'V98__added_currency_roundof_for_multipleof.sql', -2113842963, 'root', '2017-01-23 22:35:33', 2177, 1);
